...
function Home() {
  ...
  return (
    <>
      ...
      {error && (
        <p className="text-red-400 text-center my-4 bg-red-900 dark:bg-red-700 py-2 px-4 rounded">
          {error}
        </p>
      )}
      {formattedReadme && (
        <div className="bg-gray-200 dark:bg-gray-900 rounded-lg shadow-lg p-8 mt-8">
